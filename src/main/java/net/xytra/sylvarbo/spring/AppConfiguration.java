package net.xytra.sylvarbo.spring;
...
@Configuration
@ComponentScan({ "net.xytra.sylvarbo" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "net.xytra.sylvarbo");
                servletContext.setInitParameter("tapestry.development-modules", "net.xytra.sylvarbo.services.DevelopmentModule");
