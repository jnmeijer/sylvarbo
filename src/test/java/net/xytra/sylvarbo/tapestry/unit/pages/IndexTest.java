package net.xytra.sylvarbo.tapestry.unit.pages;

import org.apache.tapestry5.dom.Document;
import org.apache.tapestry5.test.PageTester;
import org.junit.jupiter.api.Test;

import net.xytra.sylvarbo.services.AppModule;
import net.xytra.sylvarbo.services.QaModule;
...
public class IndexTest {
    ...
    void test() {
        // given
        String appPackage = "net.xytra.sylvarbo";
        String appName = "App";
