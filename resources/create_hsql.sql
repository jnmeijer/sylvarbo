...
CREATE TABLE XSA_PERSON_EVENT (APPROXIMATION VARCHAR(8) NULL, DTM BIGINT NOT NULL, ID BIGINT NOT NULL, PERSON_ID BIGINT NOT NULL, PRECISION VARCHAR(8) NOT NULL, TYPE VARCHAR(8) NOT NULL, PRIMARY KEY (ID))
;
