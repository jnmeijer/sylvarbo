...
CREATE TABLE XSA_RELATIONSHIP_EVENT (APPROXIMATION VARCHAR(8) NULL, CREATED_BY_ID INTEGER NOT NULL, CREATED_DTM TIMESTAMP NOT NULL, DTM BIGINT NULL, ID BIGINT NOT NULL, MODIFIED_BY_ID INTEGER NOT NULL, MODIFIED_DTM TIMESTAMP NOT NULL, PRECISION VARCHAR(8) NULL, RELATIONSHIP_ID BIGINT NOT NULL, TYPE VARCHAR(32) NULL, LOCATION_DESC VARCHAR(256) NULL, ORIGINAL_DATE VARCHAR(256) NULL, PRIMARY KEY (ID))
;
