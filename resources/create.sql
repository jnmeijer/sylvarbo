...
CREATE TABLE XSA_PERSON_EVENT (APPROXIMATION VARCHAR(8) NULL, CREATED_BY_ID INTEGER NOT NULL, CREATED_DTM TIMESTAMP NOT NULL, DTM BIGINT NOT NULL, ID BIGINT NOT NULL, LOCATION_DESC VARCHAR(256) NULL, MODIFIED_BY_ID INTEGER NOT NULL, MODIFIED_DTM TIMESTAMP NOT NULL, PERSON_ID BIGINT NOT NULL, PRECISION VARCHAR(8) NOT NULL, TYPE VARCHAR(8) NOT NULL, PRIMARY KEY (ID))
;
